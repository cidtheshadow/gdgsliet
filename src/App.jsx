...
{/* Background grid dots matching the image */}
<div className="absolute inset-0 z-0 bg-[radial-gradient(#e5e7eb_1.5px,transparent_1.5px)] [background-size:24px_24px] opacity-70"></div>
...
<div className="bento-card md:col-span-3 rounded-3xl p-6 bg-[#FEF8EC] border border-[#FDE5BE] flex flex-col justify-start relative overflow-hidden min-h-[280px] transform hover:scale-[1.02] transition-transform" style={{ transform: `translateY(${typeof window !== 'undefined' ? window.scrollY * 0.02 - 10 : 0}px)` }}>
<div className="mb-6">
...
<div className="flex flex-col items-start gap-2.5 relative z-10">
  <div className="flex gap-2">
    <span className="px-3 py-1.5 rounded-full bg-white text-[10px] font-semibold text-[#B45309] shadow-sm border border-[#F59E0B]">Design Enthusiasts</span>
    <span className="px-3 py-1.5 rounded-full bg-white text-[10px] font-semibold text-[#B45309] shadow-sm border border-[#F59E0B]">Web Devs</span>
  </div>
  <span className="px-3 py-1.5 rounded-full bg-white text-[10px] font-semibold text-[#B45309] shadow-sm border border-[#F59E0B]">Android Geeks</span>
  <span className="px-3 py-1.5 rounded-full bg-white text-[10px] font-semibold text-[#B45309] shadow-sm border border-[#F59E0B]">Cloud Architects</span>
  <span className="px-3 py-1.5 rounded-full bg-white text-[10px] font-semibold text-[#B45309] shadow-sm border border-[#F59E0B]">Rust &amp; Go Hackers</span>
  <span className="px-3 py-1.5 rounded-full bg-white text-[10px] font-semibold text-[#B45309] shadow-sm border border-[#F59E0B]">AI Explorers</span>
</div>
</div>

{/*  Row 1 Left-Middle: Bugdroid  */}
<div className="bento-card md:col-span-2 rounded-3xl p-4 bg-[#EDF8F1] border border-[#D0ECD9] flex flex-col items-center justify-between relative overflow-hidden min-h-[280px] transform hover:scale-[1.02] transition-transform" style={{ transform: `translateY(${typeof window !== 'undefined' ? window.scrollY * -0.015 + 10 : 0}px)` }}>
...
<span className="mb-2 text-[10px] font-mono font-semibold text-[#1C6934] bg-white px-3 py-1 rounded-full shadow-sm">
        SLIET Bugdroid
      </span>
</div>

{/*  Row 1 Center-Top: 5+ Golden Years  */}
<div className="bento-card md:col-span-3 rounded-3xl p-6 bg-[#F0FDF4] border border-[#DCFCE7] flex flex-col justify-between overflow-hidden min-h-[280px] transform hover:scale-[1.02] transition-transform" style={{ transform: `translateY(${typeof window !== 'undefined' ? window.scrollY * 0.01 - 5 : 0}px)` }}>
...
<div className="w-14 h-16 bg-white p-1 rounded shadow border border-google-gray-200 transform -rotate-12 z-10">
<div className="w-full h-10 bg-blue-100 rounded flex items-center justify-center text-[8px] font-bold text-blue-800">Hack '23</div>
<div className="text-[7px] text-center font-mono text-gray-500 mt-1">DevLab</div>
</div>
<div className="w-14 h-16 bg-white p-1 rounded shadow border border-google-gray-200 transform rotate-6 z-20">
<div className="w-full h-10 bg-amber-100 rounded flex items-center justify-center text-[8px] font-bold text-amber-800">Jam '24</div>
...
{/*  Row 1 Right 1: 1,250+  */}
<div className="bento-card md:col-span-2 rounded-3xl p-6 bg-[#EFF6FF] border border-[#DBEAFE] flex flex-col justify-center items-start text-left min-h-[280px] transform hover:scale-[1.02] transition-transform" style={{ transform: `translateY(${typeof window !== 'undefined' ? window.scrollY * -0.025 + 15 : 0}px)` }}>
<div className="text-4xl sm:text-5xl font-bold text-[#2563EB] font-sans tracking-tight">
      1,250<span className="text-4xl text-[#2563EB]">+</span>
</div>
...
{/*  Row 1 Right 2: 40+  */}
<div className="bento-card md:col-span-2 rounded-3xl p-6 bg-[#FFFBEB] border border-[#FEF3C7] flex flex-col justify-center items-start text-left min-h-[280px] transform hover:scale-[1.02] transition-transform" style={{ transform: `translateY(${typeof window !== 'undefined' ? window.scrollY * 0.02 - 10 : 0}px)` }}>
<div className="text-5xl font-serif italic font-bold text-[#D97706] tracking-tight">
      40<span className="text-4xl font-serif italic font-normal text-[#D97706]">+</span>
</div>
...
<span className="text-[10px] font-mono font-bold px-3 py-1 rounded-full bg-blue-50 text-[#2563EB] border border-blue-200 uppercase tracking-wider">Diversity</span>
</div>
...
<div className="flex items-center justify-center gap-6 mt-auto relative z-10">
  <div className="w-10 h-10 rounded-full bg-white shadow-sm border border-google-gray-100 flex items-center justify-center text-sm text-blue-500">📘</div>
  <div className="w-10 h-10 rounded-full bg-white shadow-sm border border-google-gray-100 flex items-center justify-center text-sm text-emerald-500">🍵</div>
  <div className="w-10 h-10 rounded-full bg-white shadow-sm border border-google-gray-100 flex items-center justify-center text-sm text-amber-500">🔥</div>
  <div className="w-10 h-10 rounded-full bg-white shadow-sm border border-google-gray-100 flex items-center justify-center text-sm text-red-500">☁️</div>
  <div className="w-10 h-10 rounded-full bg-white shadow-sm border border-google-gray-100 flex items-center justify-center text-sm text-purple-500">📱</div>
</div>
</div>
...
<div className="flex flex-col items-center justify-start pt-2 relative z-10">
<span className="text-[10px] font-mono tracking-[0.2em] uppercase text-google-gray-400 block mb-4 font-semibold">
          SANGRUR • PUNJAB
        </span>
{/* Samarkan Font Longowal */}
<div className="relative text-center w-full flex justify-center mb-4">
  <h3 className="text-6xl text-gray-800 tracking-wide" style={{ fontFamily: "'Samarkan', sans-serif" }}>LONGOWAL</h3>
</div>

<div className="h-1.5 w-[70%] mx-auto google-bar mb-6"></div>

{/*  Gurdwara Sketch  */}
<div className="w-full h-32 relative flex flex-col justify-end items-center px-4">
<svg className="w-full h-full" fill="none" viewBox="0 0 320 120" preserveAspectRatio="xMidYMax meet">
  <path d="M60 110 L260 110" stroke="#666" strokeWidth="1.5" />
  <path d="M70 115 A5 5 0 0 0 80 115 A5 5 0 0 0 90 115 A5 5 0 0 0 100 115" stroke="#999" strokeWidth="1" fill="none" />
  <path d="M220 115 A5 5 0 0 0 230 115 A5 5 0 0 0 240 115 A5 5 0 0 0 250 115" stroke="#999" strokeWidth="1" fill="none" />
  <rect x="130" y="60" width="60" height="50" stroke="#666" strokeWidth="1.5" fill="none" />
  <rect x="90" y="70" width="40" height="40" stroke="#666" strokeWidth="1.5" fill="none" />
  <rect x="190" y="70" width="40" height="40" stroke="#666" strokeWidth="1.5" fill="none" />
  <path d="M130 60 C130 30, 160 20, 160 20 C160 20, 190 30, 190 60" stroke="#666" strokeWidth="1.5" fill="none" />
  <path d="M160 10 L160 20 M155 15 L165 15" stroke="#666" strokeWidth="1.5" />
  <path d="M90 70 C90 55, 110 50, 110 70" stroke="#666" strokeWidth="1.5" fill="none" />
  <path d="M190 70 C190 55, 210 50, 210 70" stroke="#666" strokeWidth="1.5" fill="none" />
  <path d="M145 110 L145 90 A15 15 0 0 1 175 90 L175 110" stroke="#666" strokeWidth="1.5" fill="none" />
  <path d="M100 110 L100 95 A10 10 0 0 1 120 95 L120 110" stroke="#666" strokeWidth="1.5" fill="none" />
  <path d="M200 110 L200 95 A10 10 0 0 1 220 95 L220 110" stroke="#666" strokeWidth="1.5" fill="none" />
</svg>
</div>
</div>
{/*  Industry leaders  */}
<div className="mt-4 pt-4 border-t border-google-gray-100 relative z-10">
...
<div className="relative w-24 h-32 shrink-0 bg-white rounded-2xl p-2.5 shadow-sm border border-[#C6F6D5] flex flex-col items-center justify-between text-center group-hover:rotate-2 transition-transform">
<div className="w-10 h-10 rounded-md bg-amber-50 flex items-center justify-center text-lg text-amber-600 shadow-inner mt-1 border border-amber-200">
          🏆
        </div>
<div className="my-1">
<div className="text-[6px] font-bold text-google-gray-800 uppercase tracking-tighter">GOOGLE DEVELOPERS</div>
<div className="text-[7px] font-bold text-google-blue mt-0.5">GDG SLIET</div>
</div>
<span className="text-[7px] font-mono px-2 py-0.5 rounded bg-[#EDFDF5] border border-[#C6F6D5] text-[#166534] font-semibold w-full">
          Top Chapter '24
        </span>
</div>
</div>
...
{/*  Row 3 Left: Team  */}
<div className="bento-card md:col-span-4 rounded-3xl overflow-hidden relative min-h-[240px] flex flex-col justify-end p-6 bg-[#171717] group transform hover:scale-[1.02] transition-transform" style={{ transform: `translateY(${typeof window !== 'undefined' ? window.scrollY * 0.02 - 15 : 0}px)` }}>
<div className="absolute inset-0 flex items-center justify-center z-10 opacity-30 text-[#1E3A8A] font-mono text-7xl font-extrabold select-none tracking-widest">
      &lt;TEAM/&gt;
    </div>
...
<span className="absolute bottom-8 left-10 text-xs font-mono text-amber-500 font-bold">#</span>
<span className="absolute bottom-6 right-8 text-xs font-mono text-purple-500 font-bold">func()</span>
<div className="flex items-center gap-1 mb-4">
  <span className="text-6xl font-bold text-[#4285F4]">&lt;</span>
  <span className="text-6xl font-bold text-[#34A853]">/</span>
  <span className="text-6xl font-bold text-[#EA4335]">&gt;</span>
</div>
<span className="text-[11px] font-mono font-semibold text-[#2563EB] bg-white px-4 py-1.5 rounded-full shadow-sm border border-blue-100">
...
<div className="h-16 rounded-xl bg-white border border-[#FDBA74] p-3 flex flex-col justify-between shadow-sm">
